...
val MEM_ISSUE_WIDTH = 1
val MEM_NUM_ENTRIES = 8
val MEM_DISPATCH_WIDTH = 1

val ALU_ISSUE_WIDTH = 1
val ALU_NUM_ENTRIES = 8
val ALU_DISPATCH_WIDTH = 1
  
val FPU_ISSUE_WIDTH = 1
val FPU_NUM_ENTRIES = 8
val FPU_DISPATCH_WIDTH = 1
  
val NUM_LOAD_QUEUE = 8
val NUM_STORE_QUEUE = 8

val NUM_PHYS_INT_REG = 52
val NUM_PHYS_FP_REG = 48
  
val MAX_BRANCH_COUNT = 8
val NUM_FETCH_BUFFER_ENTRIES = 16
  
val NUM_PERF_COUNTER = 2

val GLOBAL_HIST_LEN = 64
val LOCAL_HIST_LEN = 1
val LOCAL_HIST_SETS = 0
...
val FETCH_BYTES = 8
val FTQ_ENTRIES = 16
val PRE_FETCHING = false
  
val ENABLE_BRANCH_REPORT_PRINTF = true
}
